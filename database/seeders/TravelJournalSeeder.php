...
class TravelJournalSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $categories = [
            ...
            ['name' => 'Staycations',     'slug' => 'staycations',     'sort_order' => 4],
        ...
        $posts = [
            ...
            [
                'title'              => 'Why Dubai Is the World\'s Ultimate Luxury Staycation Hub',
                'slug'               => 'dubai-ultimate-luxury-staycation-hub',
                'excerpt'            => 'Experience sky-high opulence, iconic architecture, and desert adventures all within one extraordinary city that never stops reinventing itself.',
                'body'               => '<p>Dubai has perfected the art of the staycation. In a city where the newest hotel is always grander than the last, there is always a reason to rediscover it as if for the first time — even for residents.</p><p>The Atlantis The Royal, opened in 2023, redefined what a hotel experience could be: a 22-hectare waterpark, 17 celebrity chef restaurants including Nobu and Ariana Grande\'s Ari by Nobu, and suites so extravagant they have their own private pools on the balcony. The Burj Al Arab remains the city\'s icon — no visit is complete without afternoon tea in its soaring atrium.</p><p>Beyond the hotels, Dubai\'s culinary scene has exploded. Tresind Studio holds a Michelin star for its reinvention of Indian cuisine; Ossiano at Atlantis The Palm serves dinner beneath an aquarium containing 65,000 sea creatures.</p><p>For adventure, a private dune driving experience in the Empty Quarter at golden hour, followed by a traditional Emirati dinner under the stars, is an experience that no city on earth can replicate.</p>',
                'cover_image_url'    => 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?auto=format&fit=crop&w=800&q=80',
                'blog_category_id'   => $catId('staycations'),
                'read_time_minutes'  => 6,
