...
.mn-highlight-desc { font-family: 'Jost', sans-serif; font-size: 14.5px; color: var(--white-60); font-weight: 400; line-height: 1.6; }
...
.mn-inc-list li, .mn-exc-list li {
  ...
  font-family: 'Jost', sans-serif; font-size: 15.5px; color: var(--white-60); font-weight: 400; line-height: 1.5;
}
...
.mn-cancel-table tbody td {
  font-family: 'Jost', sans-serif; font-size: 15px; color: var(--white-60); font-weight: 400;
...
/* ===== SIDEBAR ===== */
.mn-sidebar-wrap { display: flex; flex-direction: column; gap: 20px; }
...
.mn-price-val { font-family: 'Jost', sans-serif; font-size: 2.8rem; font-weight: 200; color: #fff; line-height: 1.2; margin-bottom: 4px; white-space: nowrap; }
.mn-price-val .curr { font-size: 1.6rem; color: var(--gold); vertical-align: middle; margin-right: 4px; }
...
.mn-info-val { color: #fff; font-weight: 500; font-size: 15px; }
...
.mn-contact-item { display: flex; align-items: center; gap: 12px; font-family: 'Jost', sans-serif; font-size: 15.5px; font-weight: 400; color: var(--white-60); margin-bottom: 12px; }
...
.mn-note {
  ...
  padding: 20px 24px; font-family: 'Jost', sans-serif; font-size: 15.5px;
  ...
  <div class="mn-container">
        ...
        <div class="mn-sidebar-wrap">
          ...
          <div class="mn-sidebar-card">
            ...
            <div class="mn-price-card-body">
              ...
              <a href="https://wa.me/919875073788?text=Hi!%20I'm%20interested%20in%20the%20Manali%20Sisu%20Kasol%203N4D%20package" target="_blank" class="mn-btn">
                <i class="fa-solid fa-calendar-check" style="margin-right:8px;"></i> Book Now
              </a>
              <a href="https://wa.me/919875073788" target="_blank" class="mn-btn-outline">
    ...
    <div class="mn-full-width-col" style="max-width: 900px; margin: 0 auto;">
        ...
        <div class="mn-section" id="contact" style="border-bottom:none;">
          ...
          <h2 class="mn-section-title">Contact <em>TYTLuxe</em></h2>
          <div class="mn-note">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:24px;">
            <div class="mn-contact-card">
              ...
              <div class="mn-contact-item"><i class="fa-solid fa-phone"></i> +91 9875073788</div>
              <div class="mn-contact-item"><i class="fa-solid fa-envelope"></i> takeyourtrip7@gmail.com</div>
              <div class="mn-contact-item"><i class="fa-solid fa-globe"></i> www.tytluxe.in</div>
              <div class="mn-contact-item"><i class="fa-solid fa-location-dot"></i> 831, Tower C, Bhutani Alphathum, Sector 90, Noida UP-201305</div>
            </div>
            <div class="mn-contact-card">
              <div class="mn-contact-title">Why TYTLuxe?</div>
        ...
        {{-- GALLERY SECTION --}}
        <div class="mn-section" id="gallery" style="border-bottom:none;">
          <div class="mn-section-label">Gallery</div>
          <h2 class="mn-section-title">Memories of <em>Manali</em></h2>
