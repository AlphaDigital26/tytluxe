...
.jb-left-col { display: flex; flex-direction: column; }
...
.jb-highlight-desc {
  ...
  color: var(--white-60); font-weight: 400; line-height: 1.6;
}
...
.jb-day-body {
  font-family: 'Jost', sans-serif; font-size: 16.5px;
  color: var(--white-60); line-height: 1.85; font-weight: 400; text-align: justify;
}
...
.jb-inc-list li, .jb-exc-list li {
  ...
  font-family: 'Jost', sans-serif; font-size: 15.5px;
  color: var(--white-60); font-weight: 400; line-height: 1.5;
}
...
/* ===== SIDEBAR ===== */
.jb-sidebar-wrap { display: flex; flex-direction: column; gap: 20px; }
.jb-sidebar-card {
...
.jb-price-val { font-family: 'Jost', sans-serif; font-size: 2.8rem; font-weight: 200; color: #fff; line-height: 1.2; margin-bottom: 4px; white-space: nowrap; }
.jb-price-val .curr { font-size: 1.6rem; color: var(--gold); vertical-align: middle; margin-right: 2px; }
.jb-price-pp {
...
.jb-info-val { color: #fff; font-weight: 500; font-size: 15px; }
...
.jb-contact-item { display: flex; align-items: center; gap: 12px; font-family: 'Jost', sans-serif; font-size: 15.5px; font-weight: 400; color: var(--white-60); margin-bottom: 12px; }
...
<section class="jb-hero" id="overview">
  ...
  <div class="jb-hero-content">
    ...
    <div class="jb-hero-pills">
      ...
      <div class="jb-pill"><i class="fa-solid fa-utensils"></i> MAP AI</div>
...
<div class="jb-page">
  <div class="jb-container">
        ...
        <div class="jb-sidebar-wrap">
          ...
          <div class="jb-sidebar-card">
            ...
            <div class="jb-price-card-body">
              ...
              <a href="https://wa.me/919875073788?text=Hi!%20I'm%20interested%20in%20the%20Jibhi%20Tirthan%20Valley%202N3D%20package" target="_blank" class="jb-btn">
                <i class="fa-solid fa-calendar-check" style="margin-right:8px;"></i> Book Now
              </a>
              <a href="https://wa.me/919875073788" target="_blank" class="jb-btn-outline">
    ...
    <div class="jb-full-width-col" style="max-width: 900px; margin: 0 auto;">
...
<div class="jb-section" id="itinerary">
        ...
        <div class="jb-section" id="booking">
          ...
          <div class="jb-note" style="margin-bottom:32px;">
            <strong>Booking Confirmation Policy:</strong> Kindly ensure that a confirmation email is received from TYTLuxe. Payments must be made as per the payment policy to confirm the booking. <strong>Booking amount: ₹2,000 per person.</strong>
          </div>
        ...
        {{-- CONTACT --}}
        <div class="jb-section" id="contact" style="border-bottom:none; margin-top: auto;">
          <div class="jb-section-label">Get in Touch</div>
          <h2 class="jb-section-title">Contact <em>TYTLuxe</em></h2>
          <div class="jb-note">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-top:24px;">
            <div class="jb-contact-card">
              ...
              <div class="jb-contact-item"><i class="fa-solid fa-phone"></i> +91 9875073788</div>
              <div class="jb-contact-item"><i class="fa-solid fa-envelope"></i> takeyourtrip7@gmail.com</div>
              <div class="jb-contact-item"><i class="fa-solid fa-globe"></i> www.tytluxe.in</div>
              <div class="jb-contact-item"><i class="fa-solid fa-location-dot"></i> 831, Tower C, Bhutani Alphathum, Sector 90, Noida UP-201305</div>
            </div>
            <div class="jb-contact-card">
              <div class="jb-contact-title">Why TYTLuxe?</div>
